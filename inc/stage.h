...
// Tile attributes (PXA)
// High nibble is flags that can be used in combination
#define BLOCK_SLOPE 0x10
#define BLOCK_WATER 0x20
#define BLOCK_FOREGROUND 0x40
#define BLOCK_WIND 0x80
// Low nibble is distinct values
// These are the values for most tile types, but don't apply to SLOPE or WIND
