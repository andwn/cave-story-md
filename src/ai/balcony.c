...
void ai_helicopter(Entity *e) {
	...
	switch(e->state) {
		case 0:		// stopped
		{
			b = entity_create(e->x + (26<<CSF) - (56<<CSF), e->y - (9<<CSF) - (48<<CSF), OBJ_HELICOPTER_BLADE, 0);
			//b->sprite = SPR_HELICOPTER_BLADE_1;
			b->linkedEntity = e;
			
			b = entity_create(e->x - (4<<CSF) - (56<<CSF), e->y - (4<<CSF) - (48<<CSF), OBJ_HELICOPTER_BLADE, NPC_OPTION2);
		...
		{
			entity_create(e->x + (45<<CSF) - (56<<CSF), e->y + (34<<CSF) - (48<<CSF), OBJ_MOMORIN, 0)->dir = 0;
		...
		{
			entity_create(e->x + (47<<CSF) - (56<<CSF), e->y + (34<<CSF) - (48<<CSF), OBJ_MOMORIN, 0)->dir = 0;
			entity_create(e->x + (34<<CSF) - (56<<CSF), e->y + (34<<CSF) - (48<<CSF), OBJ_SANTA, 0)->dir = 0;
			entity_create(e->x + (21<<CSF) - (56<<CSF), e->y + (34<<CSF) - (48<<CSF), OBJ_CHACO, 0)->dir = 0;
