...
#ifdef PAL
#define NPC_WALKSPEED		0x200
#define NPC_RUNSPEED		0x400
#define NPC_MAXFALLSPEED	0x5FF
#else
#define NPC_WALKSPEED		0x1D0
#define NPC_RUNSPEED		0x3A0
#define NPC_MAXFALLSPEED	0x4FF
#endif
