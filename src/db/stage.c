...
const stage_info_def stage_info[STAGE_COUNT] = {
	...
	{ PXM_MazeI,	PXE_MazeI,	TSC_MazeI,	&PAL_X,		13,	8,	"Labyrinth I" },
	...
	{ PXM_MazeH,	PXE_MazeH,	TSC_MazeH,	&PAL_X,		13,	8,	"Labyrinth H" },
	...
	{ PXM_MazeB,	PXE_MazeB,	TSC_MazeB,	&PAL_X,		13,	8,	"Labyrinth B" },
