...
const npc_info_def npc_info[NPC_COUNT + 9 + 14 + 3] = {
	...
	{ &SPR_ShovelMimi,NOSHEET,PAL3,1, &ai_null, &ai_mimiga_caged, &ai_null }, // Shovel Brigade (Caged)
	{ &SPR_Chie, 	NOSHEET, PAL3, 1, &ai_null, &ai_mimiga_caged, &ai_null }, // Chie (Caged)
	{ &SPR_Chaco, 	NOSHEET, PAL3, 1, &ai_null, &ai_mimiga_caged, &ai_null }, // Chaco (Caged)
	{ &SPR_Doctor, 	NOSHEET, PAL3, 1, &onspawn_persistent, &ai_boss_doctor, &ondeath_default }, // Doctor (Boss)
	...
	{ NULL, 		NOSHEET, PAL0, 1, &onspawn_persistent, &ai_boss_doctor_frenzied, &ai_null }, // Muscle Doctor (Boss)
	...
	{ NULL, 		NOSHEET, PAL0, 1, &onspawn_persistent, &ai_red_energy, &ai_null }, // Red Energy
