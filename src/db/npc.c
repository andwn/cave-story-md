...
const npc_info_def npc_info[NPC_COUNT + 8] = {
	...
	{ &SPR_Curly, 	PAL3, 3, "Curly",
		&oncreate_snap, &ai_curly_onUpdate, &ai_curly_onState },
	...
	{ &SPR_MGunB1, 	PAL0, 3, "Curly Projectile",
		NULL, &ai_curlyBossShot_onUpdate, NULL },
	...
	{ &SPR_ToroBlock, PAL1, 3, "Block",
		NULL, &ai_torokoBlock_onUpdate, NULL },
	{ &SPR_ToroFlower, PAL3, 3, "Flowercub",
		NULL, &ai_torokoFlower_onUpdate, &ai_default_onState },
	...
	{ &SPR_Quote, 	PAL0, 3, "Quote",
		NULL, &ai_player_onUpdate, &ai_player_onState },
	...
	{ &SPR_LabShot, PAL2, 3, "Gaudi Projectile",
		NULL, &ai_gaudiArmoredShot_onUpdate, NULL },
	...
	{ &SPR_Curly, 	PAL3, 3, "Curly (Collapsed)",
		NULL, &ai_curly_onUpdate, &ai_curly_onState },
	...
	{ &SPR_CoreThingShot, PAL2, 3, "Fire Whirr Projectile",
		NULL, &ai_firewhirr_shot, &ai_default_onState },
