...
const npc_info_def npc_info[NPC_COUNT + 8] = {
	...
	{ &SPR_Balrog, 	PAL1, 3, "Balrog (Second Fight)",
		&ai_balrog_onCreate, &ai_balrogFlying_onUpdate, &ai_balrogFlying_onState, NULL },
	...
	{ &SPR_Balrog, 	PAL1, 3, "Balrog (First Fight)",
		&ai_balrog_onCreate, &ai_balrogRunning_onUpdate, &ai_balrogRunning_onState, NULL },
	...
	{ &SPR_Balrog, 	PAL1, 3, "Balrog (Third Fight)",
		&ai_balrog_onCreate, &ai_balrog_boss_missiles, &ai_default_onState, NULL },
