...
const npc_info_def npc_info[NPC_COUNT + 8] = {
	...
	{ &SPR_Bubble, 	PAL0, 3, "Misery's Bubble",
		NULL, &ai_miseryBubble_onUpdate, NULL },
	{ &SPR_Misery, 	PAL0, 3, "Misery (Floating)",
		NULL, &ai_miseryFloat_onUpdate, &ai_miseryFloat_onState },
	...
	{ &SPR_Polar, 	PAL0, 3, "Curly Polar Star",
		&oncreate_persistent, NULL, &ai_default_onState },
	{ &SPR_MGun, 	PAL0, 3, "Curly Machine Gun",
		&oncreate_persistent, NULL, &ai_default_onState },
	{ NULL, 		PAL0, 3, "Curly Bubble Shield",
		&oncreate_persistent, NULL, &ai_default_onState },
	...
	{ &SPR_Buggy2, 	PAL3, 3, "Scooter (Pieces)",
		NULL, NULL, NULL },
