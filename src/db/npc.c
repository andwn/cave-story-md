...
const npc_info_def npc_info[NPC_COUNT + 8] = {
	...
	{ &SPR_Balrog, 	PAL1, 3, "Balrog (Busts in)",
		&oncreate_balrog, &ai_balrog_bust_in, NULL, NULL },
	...
	{ &SPR_Bat, 	PAL0, 3, "Bat (Circling)",
		NULL, &ai_batCircle_onUpdate, &ai_default_onState, NULL },
	...
	{ &SPR_Balrog, 	PAL1, 3, "Balrog (Second Fight)",
		&oncreate_balrog, &ai_balrogFlying_onUpdate, &ai_balrogFlying_onState, NULL },
	...
	{ &SPR_Kazuma, 	PAL3, 3, "Kazuma",
		&oncreate_snap, &ai_kazuma, NULL, NULL },
	...
	{ &SPR_Toroko, 	PAL3, 3, "Toroko",
		&ai_op2flip_onCreate, &ai_toroko, NULL, NULL },
	{ &SPR_King, 	PAL3, 3, "King",
		&ai_op2flip_onCreate, &ai_king, NULL, NULL },
	{ &SPR_KazuCom, PAL3, 3, "Kazuma (Computer)",
		&oncreate_snap, &ai_npc_at_computer, NULL, NULL },
	...
	{ &SPR_Balrog, 	PAL1, 3, "Balrog (First Fight)",
		&oncreate_balrog, &ai_balrogRunning_onUpdate, &ai_balrogRunning_onState, NULL },
	...
	{ &SPR_Jack, 	PAL3, 3, "Jack",
		&oncreate_snap, &ai_jack, NULL, NULL },
	...
	{ &SPR_Frog, 	PAL3, 3, "Frog",
		NULL, &ai_frog_onUpdate, &ai_default_onState, NULL },
	{ &SPR_Hey, 	PAL1, 3, "Hey!",
		NULL, &ai_hey_onUpdate, NULL, NULL },
	...
	{ &SPR_Booster, PAL3, 3, "Prof. Booster",
		&oncreate_snap, &ai_booster, NULL, NULL },
	...
	{ &SPR_Curly, 	PAL3, 3, "Curly",
		&oncreate_snap, &ai_curly_onUpdate, &ai_curly_onState, NULL },
	{ &SPR_CurlyB, 	PAL3, 3, "Curly (Boss)",
		&ai_pushdn_onCreate, &ai_curlyBoss_onUpdate, &ai_curlyBoss_onState, NULL },
	{ &SPR_Table, 	PAL1, 2, "Tables & Chair",
		NULL, NULL, NULL, NULL },
	{ &SPR_CurlyMimi, PAL3, 3, "Bar Mimiga 1",
		NULL, &ai_curlys_mimigas, &ai_default_onState, NULL },
	...
	{ &SPR_Sunstone, PAL2, 3, "Sunstone",
		&ai_sunstone_onCreate, &ai_sunstone_onUpdate, NULL, NULL },
	...
	{ &SPR_Jenka, 	PAL3, 3, "Jenka",
		NULL, &ai_jenka, NULL, NULL },
	{ &SPR_Armadl, 	PAL3, 3, "Armadillo",
		NULL, &ai_armadillo_onUpdate, &ai_default_onState, NULL },
	...
	{ &SPR_Doctor, 	PAL3, 3, "Doctor (Crowned)",
		&oncreate_snap, &ai_doctor, NULL, NULL },
	...
	{ &SPR_ToroBlock, PAL1, 3, "Block",
		NULL, &ai_torokoBlock_onUpdate, NULL, NULL },
	{ &SPR_ToroFlower, PAL3, 3, "Flowercub",
		NULL, &ai_torokoFlower_onUpdate, &ai_default_onState, NULL },
	{ &SPR_Jenka, 	PAL3, 3, "Jenka (Collapsed)",
		&ai_jenka_onCreate, NULL, NULL, NULL },
	/* 0x090 (144) */
	{ &SPR_Toroko, 	PAL3, 3, "Toroko (Teleport In)",
		NULL, &ai_toroko_teleport_in, NULL, NULL },
	{ NULL, 		PAL0, 3, "???",
		NULL, NULL, NULL, NULL },
	{ NULL, 		PAL0, 3, "Lightning",
		NULL, NULL, NULL, NULL },
	{ &SPR_CritterP, PAL2, 3, "Purple Critter",
		&ai_pushdn_onCreate, &ai_critter_onUpdate, &ai_critter_onState, NULL },
	...
	{ &SPR_Robot, 	PAL3, 3, "Blue Robot",
		NULL, &ai_blue_robot, NULL, NULL },
	{ NULL, 		PAL0, 3, "Shutter (Stuck)",
		NULL, NULL, NULL, NULL },
	{ &SPR_Gaudi, PAL2, 3, "Gaudi",
		NULL, &ai_gaudi_onUpdate, &ai_default_onState, NULL },
	{ &SPR_Gaudi, PAL2, 3, "Gaudi (Defeated)",
		NULL, &ai_gaudiDying_onUpdate, &ai_default_onState, NULL },
	{ &SPR_Gaudi, PAL2, 3, "Gaudi (Flying)",
		NULL, &ai_gaudiFlying_onUpdate, &ai_default_onState, NULL },
	{ &SPR_LabShot, PAL2, 3, "Gaudi Projectile",
		NULL, &ai_gaudiArmoredShot_onUpdate, NULL, NULL },
	...
	{ NULL, 		PAL0, 3, "Pooh Black",
		NULL, &ai_pooh_black, &ai_default_onState, NULL },
	{ NULL, 		PAL0, 3, "Pooh Black Projectile",
		NULL, &ai_pooh_black_bubble, NULL, NULL },
	{ NULL, 		PAL0, 3, "Pooh Black (Defeated)",
		NULL, &ai_pooh_black_dying, NULL, NULL },
	{ NULL, 		PAL0, 3, "Dr. Gero",
		NULL, NULL, NULL, NULL },
	...
	{ &SPR_Booster, PAL3, 3, "Prof. Booster (Fall)",
		NULL, &ai_booster_falling, NULL, NULL },
	{ NULL, 		PAL0, 3, "Boulder",
		NULL, NULL, NULL, NULL },
	{ &SPR_Balrog, 	PAL1, 3, "Balrog (Third Fight)",
		&oncreate_balrog, &ai_balrog_boss_missiles, &ai_default_onState, NULL },
	{ NULL, 		PAL0, 3, "Balrog Missile",
		NULL, &ai_balrog_missile, NULL, NULL },
	{ NULL, 		PAL0, 3, "Fire Whirr",
		NULL, NULL, &ai_default_onState, NULL },
	{ NULL, 		PAL0, 3, "Fire Whirr Projectile",
		NULL, NULL, &ai_default_onState, NULL },
	{ &SPR_GaudiArmor, 	PAL2, 3, "Gaudi Armor",
		NULL, &ai_gaudiArmored_onUpdate, &ai_default_onState, NULL },
