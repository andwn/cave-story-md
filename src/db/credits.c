...
const credits_info_def credits_info[] = {
	...
	C_TEXT(" Outside flutterer: Night Spirit"),		C_ICON(NIGHTSPR,3), C_WAIT(48),
	...
	C_MOVE(32),
	C_WAIT(32),
	C_TEXT("Torai"),				C_ICON(DEBUGCAT,3), C_WAIT(48),
	C_TEXT("Naoku"),				C_ICON(SWORD,	3), C_WAIT(48),
	C_TEXT("Kuroihito"),			C_ICON(KUROI,	3), C_WAIT(48),
	C_TEXT("BA2"),					C_ICON(BA2,		3), C_WAIT(48),
	C_TEXT("Okami"),				C_ICON(OKAMI,	3), C_WAIT(48),
	C_TEXT("Nao"),					C_ICON(NAO,		3), C_WAIT(48),
	C_TEXT("Shih Tzu"),				C_ICON(PUPPY,	3), C_WAIT(48),
	C_TEXT("Gideon Zhi"),			C_ICON(GIDEON,	3), C_WAIT(48),
	C_TEXT("And many others"),							C_WAIT(48),
...
const illustration_info_def illustration_info[20] = {
	{ NULL,                  0,                             NULL,                  NULL       },
	{ (uint32_t*) PAT_Ill01, sizeof(PAT_Ill01) / TILE_SIZE, (uint16_t*) MAP_Ill01, &PAL_Ill01 },
	{ (uint32_t*) PAT_Ill02, sizeof(PAT_Ill02) / TILE_SIZE, (uint16_t*) MAP_Ill02, &PAL_Ill02 },
	{ (uint32_t*) PAT_Ill03, sizeof(PAT_Ill03) / TILE_SIZE, (uint16_t*) MAP_Ill03, &PAL_Ill03 },
	{ (uint32_t*) PAT_Ill04, sizeof(PAT_Ill04) / TILE_SIZE, (uint16_t*) MAP_Ill04, &PAL_Ill04 },
	{ (uint32_t*) PAT_Ill05, sizeof(PAT_Ill05) / TILE_SIZE, (uint16_t*) MAP_Ill05, &PAL_Ill05 },
	{ (uint32_t*) PAT_Ill06, sizeof(PAT_Ill06) / TILE_SIZE, (uint16_t*) MAP_Ill06, &PAL_Ill06 },
	{ (uint32_t*) PAT_Ill07, sizeof(PAT_Ill07) / TILE_SIZE, (uint16_t*) MAP_Ill07, &PAL_Ill07 },
	{ (uint32_t*) PAT_Ill08, sizeof(PAT_Ill08) / TILE_SIZE, (uint16_t*) MAP_Ill08, &PAL_Ill08 },
	{ (uint32_t*) PAT_Ill09, sizeof(PAT_Ill09) / TILE_SIZE, (uint16_t*) MAP_Ill09, &PAL_Ill09 },
	{ (uint32_t*) PAT_Ill10, sizeof(PAT_Ill10) / TILE_SIZE, (uint16_t*) MAP_Ill10, &PAL_Ill10 },
	{ (uint32_t*) PAT_Ill11, sizeof(PAT_Ill11) / TILE_SIZE, (uint16_t*) MAP_Ill11, &PAL_Ill11 },
	{ (uint32_t*) PAT_Ill12, sizeof(PAT_Ill12) / TILE_SIZE, (uint16_t*) MAP_Ill12, &PAL_Ill12 },
	{ NULL,                  0,                             NULL,                  NULL       },
	{ (uint32_t*) PAT_Ill14, sizeof(PAT_Ill14) / TILE_SIZE, (uint16_t*) MAP_Ill14, &PAL_Ill14 },
	{ (uint32_t*) PAT_Ill15, sizeof(PAT_Ill15) / TILE_SIZE, (uint16_t*) MAP_Ill15, &PAL_Ill15 },
	{ (uint32_t*) PAT_Ill16, sizeof(PAT_Ill16) / TILE_SIZE, (uint16_t*) MAP_Ill16, &PAL_Ill16 },
	{ (uint32_t*) PAT_Ill17, sizeof(PAT_Ill17) / TILE_SIZE, (uint16_t*) MAP_Ill17, &PAL_Ill17 },
	{ (uint32_t*) PAT_Ill18, sizeof(PAT_Ill18) / TILE_SIZE, (uint16_t*) MAP_Ill18, &PAL_Ill18 },
	{ NULL,                  0,                             NULL,                  NULL       },
};
