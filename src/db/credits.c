...
enum Casts {
	...
	MIDORIN,	GUNFISH,	STUMPY,		NUMAHCHI,	REDDEMON,	__NA01,
	IGOR,		MISERYF,	SUEF,		ROLLING,	DELEET,		BUTE,
	__NA02,		__NA03,		MESA,		GRNDEVIL,	__NA04,		__NA05,
	BALLOS,		BALFROG,	OMEGA,		CORE,		UNDCORE,	TOROKOF,
	DOCTORF,	BALLOS2,	HVPRESS,	__NA06,		__NA07,		__NA08,
	__NA09,		__NA10,		NAO,		__NA11,		KUROI,		OKAMI,
	__NA12,		SWORD,		__NA13,		GIDEON,		__NA14,		__NA15,
	__NA16,		THANKSW,	THANKSB,
};
...
const credits_info_def credits_info[] = {
	...
	C_WAIT(32),
	C_TEXT("Access"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Gestation"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Mimiga Village"),		C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Plant"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Balrog's Theme"),		C_ICON(MUSIC,	1), C_WAIT(32),
	C_WAIT(32),
	C_TEXT("Gravity"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Cemetery"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Safety"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Mischievous Robot"),	C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Pulse"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_WAIT(32),
	C_TEXT("On to Grasstown"),		C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Eyes of Flame"),		C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Meltdown 2"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Tyrant"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Run!"),					C_ICON(MUSIC,	1), C_WAIT(32),
	C_WAIT(32),
	C_TEXT("Jenka 1"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Jenka 2"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Labyrinth Fight"),		C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Geothermal"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Oppression"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_WAIT(32),
	C_TEXT("Living Waterway"),		C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Quiet"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Scorching Back"),		C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Moonsong"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Hero's End"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_WAIT(32),
	C_TEXT("Cave Story"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Last Cave"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Balcony"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Charge"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Zombie"),				C_ICON(MUSIC,	1), C_WAIT(32),
	C_WAIT(32),
	C_TEXT("Last Battle"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Break Down"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Running Hell"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("Seal Chamber"),			C_ICON(MUSIC,	1), C_WAIT(32),
	C_TEXT("The Way Back Home"),	C_ICON(MUSIC,	1), C_WAIT(32),
	...
	C_WAIT(64),
	C_TEXT("Thank you very much."), C_ICON(THANKSB, 3), C_WAIT(32),
	C_WAIT(240),
	C_MOVE(120),
